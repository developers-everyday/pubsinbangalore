        ...
        <div className="mx-auto max-w-6xl px-6 py-8">
          ...
          <div className="mb-6 rounded-lg border border-amber-200 bg-amber-50 p-4">
            ...
            <p className="mt-2 text-xs leading-relaxed text-amber-800">
              Information on this website is aggregated from multiple sources including user
              contributions, public listings, and third-party platforms. While we strive for
              accuracy, we cannot guarantee the completeness or reliability of all information.
              Pub details such as cover charges, entry policies, and operating hours are subject to
              change without notice. Users are encouraged to verify details directly with venues
              before visiting. PubsInBangalore is not responsible for any decisions made based on
              information found on this site. Please drink responsibly and follow local laws.
            </p>
            <Link
              href="/disclaimer"
          ...
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <div className="flex gap-4 text-sm">
              <Link href="/disclaimer" className="text-slate-600 transition hover:text-slate-900">
                Disclaimer
              </Link>
